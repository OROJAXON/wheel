...
const names = ['Hayden', 'subzero', 'Mattuchu', 'sami', 'sd22', 'gluebulas', 'dragonball', 'jonny2009', 'jonny', 'mm2 kia', 'kuna', 'brother', 'volt', 'useer', ]
const predeterminedWinner = 'dragonball';
